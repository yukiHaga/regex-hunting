...
export const AdvancedGameDescriptionDialog = ({
  ...
  const slideContent = useMemo(() => [
    {
      title: "上級編",
      sentence: "上級編を始める前に、選択、先読み、アンカーについて学習しましょう！ そして、上級編のゲームを通して、これらの特殊文字を使用した正規表現をマスターしましょう！",
      slideNum: 0
    },
    {
      title: "正規表現のマッチについて",
    ...
    {
      title: "ルール説明",
      sentence: "上級編では、選択、先読み、アンカーを使用する正規表現を学習していきます。時間内に正しい正規表現を入力すると、モンスターに攻撃できます。モンスターのHPを0にしたらゲームクリアです！",
      slideNum: 6
    }
  ], []);
