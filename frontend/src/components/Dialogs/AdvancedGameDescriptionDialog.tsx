...
export const AdvancedGameDescriptionDialog = ({
  ...
  const slideContent = useMemo(() => [
    ...
    },
    {
      ...
      sentence: "通常、マッチしたものが見つかった場合、それ以上マッチを試行するのをやめます。しかし、gオブションをつけている場合、マッチした文字列が見つかった後も、後ろの文字列に対して正規表現がマッチするかを試行します。そのため、Javaにもマッチします。以上が、ターゲット文字列に正規表現を適用させた時のマッチの流れです。実際の正規表現エンジンは最適化されている為、このようなマッチの流れと異なる動作をする場合があります。しかし、基本的にはこのようなマッチの流れなので、知っておくと正規表現を作るときに役立ちます。",
      slideNum: 2
    },
    {
      title: "肯定の先読みとは？",
