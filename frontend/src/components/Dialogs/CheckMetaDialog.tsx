                          ...
                          }
                          {
                            row.name === '(...)' &&
                              <>
                                ...
                                キャプチャグループを使用すると、複数の文字列を1つのグループにできます。そして、グループ部分にマッチする文字列が存在する場合、その文字列をキャプチャ(マッチした文字列を記憶)します。キャプチャした文字列は、正規表現中のキャプチャした位置より後ろで利用することができます(後方参照)。また、グループを作りたいがキャプチャ機能は不要な場合、非キャプチャグループを使用します。パフォーマンスを考えると、キャプチャ機能が不要な場合、非キャプチャグループを使用した方が良いです。しかし、本サービスでは、厳密性よりも見やすさと分かりやすさを重視している為、基本的には非キャプチャグループではなく、キャプチャグループを使用します。
                              </>
                          }
                          {
                            ...
                            row.example === 'ターゲット文字列内のmlの数字のみにマッチさせたい場合' &&
                              <>
                                ...
                                <StyledDescriptionDiv>
                                  また、以下のコードのように、マッチさせたくない文字列を含んでいるかをチェックするために、否定の先読みを使用することもできます。
                                </StyledDescriptionDiv>
