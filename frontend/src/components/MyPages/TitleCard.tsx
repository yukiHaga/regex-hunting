...
export const TitleCard = memo(
  ({ name, releaseDate, onClick }: TitleCardArg): JSX.Element => {
    return (
      <>
        <InnerTitleCardWrapper onClick={onClick} name={name}>
          {!releaseDate && (
            <>
              <MaskTitleCardWrapper />
            </>
          )}
          <TitleCardSentenceWrapper>{name}</TitleCardSentenceWrapper>
